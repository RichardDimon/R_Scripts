Custom_Site_OptGenMix <- function(max_steps=max_steps,samplethreshold=samplethreshold, sitethreshold=sitethreshold,
  ...
  cat("removing the follwoing sites as they don't meet the provided sample threshold of ", samplethreshold, " samples: ")
  cat(not_n5_sites)

if (any(sites_to_force%in%not_n5_sites)){
    cat("Awwwww, SNAP! some of the sites provided in the forced site list have been removed! change your forced site list and try again :) ")
  } else{
