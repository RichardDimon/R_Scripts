Custom_Individual_OptGenMix <- function(max_steps=max_steps, run_removesamples=run_removesamples,
  ...
  if (run_removesamples==TRUE){
    ...
    ggsave(paste0("3. Optimised Vs Removing Samples Common Alleles", max_t,"_",IncludeNA,".tiff"), path = paste0(OGM_dir), width = 8, height = 6, dpi = 600, units = "in")
    ...
    ggplot() +       
      ...
      ggsave(paste0("3. Optimised Vs Removing Samples Rare Alleles", max_t,"_",IncludeNA,".tiff"), path = paste0(OGM_dir), width = 8, height = 6, dpi = 600, units = "in")
